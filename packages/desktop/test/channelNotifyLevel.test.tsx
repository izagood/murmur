...
const pref = (channelId: string, notifyLevel: NotifyLevel): ChannelPrefRow =>
  ({ accountId: 'u1', channelId, mutedAt: '2026-09-03T00:00:00.000Z', starredAt: null, notifyLevel });
...
describe('채널 알림 수준 — 미읽음 배지', () => {
  const renderSidebar = () => {
    ...
    render(<Sidebar onLogout={vi.fn()} onOpenSettings={vi.fn()} onOpenDirectory={vi.fn()} onOpenInbox={vi.fn()} onOpenChannelDirectory={vi.fn()} collapsed={false} onToggleCollapse={vi.fn()} />);
  };
