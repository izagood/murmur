...
import type { AccountStatus, AccountView, ChannelRow, ChannelPrefRow, DmView, InboxEntry, LeaseRow, MessageRow, PinRow } from '@murmur/shared';
...
const initial = {
  ...
  online: [], leases: [], connected: false, channelPrefs: {}, pins: {}, drafts: {},
