...
export const en = {
  ...
  'collab.detail.ops': 'Operations',
  'collab.detail.noOps': 'No operations yet — the intent is open',
  'collab.detail.conflicts': 'Conflicts',
  'collab.detail.decisions': 'Decisions',
  'collab.opStatus.proposed': 'proposed',
  'collab.opStatus.validating': 'validating',
  'collab.opStatus.accepted': 'accepted',
  'collab.opStatus.rejected': 'rejected',
  'collab.opStatus.superseded': 'superseded',
  'collab.opStatus.needs_decision': 'needs a decision',
  'collab.opStatus.quarantined': 'quarantined',
